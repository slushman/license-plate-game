...
const AllLists = () => {
  ...
  return (
    <div className="p-4">
      <Header onClickScore={handleOpenModal} onReset={handleResetGame} score={score} />
      <main className="flex flex-col items-center">
        ...
        <List items={filtered(data.NativeAmericanNations)} onChange={handleChangeSelected} selected={selected} title="Native American Nations" />
        ...
        <BackToTop />
        <ScoreModal alertText={alertText} close={handleCloseModal} score={score} selected={selected} setAlertText={setAlertText} show={showModal} />
      </main>
    </div>
  );
};
